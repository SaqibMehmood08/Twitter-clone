...
p-3 " id="sticky-sidebar">
    ...
    @foreach ($posts as $posts )
        ...
        <div class="row user mb-1  p-3 ">
            <div class="col-4 ">
                <img src="/storage/{{$posts->user->profile->profile}}"
                    class="rounded-circle w-75 p-1" alt="">
            </div>

            <div class="col-5 ">
                <div class="username">
                    <a href="/profile/{{$posts->user->id}}/edit">{{ $posts->user->email }}</a>
                    <div class="userId">
                    {{ $posts->user->username }}
                    </div>
                </div>
            ...
            <div class="col-3 ">
                <div id="app">
<example-component user-id="{{ $posts->user->id }}"></example-component>
